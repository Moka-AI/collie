    ...
    def _pad(
        ...
        if max_length is not None:
            ...
            if 'position_ids' not in encoded_inputs:
                ...
                block_position_ids = np.concatenate(
                    [np.zeros(context_length, dtype=np.int64), np.arange(1, seq_length - context_length + 1, dtype=np.int64)]
                )
        ...
        if needs_to_be_padded:
            ...
            if 'position_ids' in encoded_inputs:
                encoded_inputs['position_ids'] = np.pad(encoded_inputs['position_ids'], pad_width=[(0, 0), (difference, 0)])
